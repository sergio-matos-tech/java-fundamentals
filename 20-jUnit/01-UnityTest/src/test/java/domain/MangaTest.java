...
class MangaTest {
    ...
    @BeforeEach
    public void setUp() {
        manga1 = new Manga("Kemetsuo no yaiba", 24);
        manga2 = new Manga("Kemetsuo no yaiba", 24);
    }

    @Test
    public void accessors_ReturnData_WhenInitialized() {
        Assertions.assertEquals("Kemetsuo no yaiba", manga1.name());
    ...
    @Test
    public void constructor_ThrowsNullPointerException_WhenNameIsNull() {
